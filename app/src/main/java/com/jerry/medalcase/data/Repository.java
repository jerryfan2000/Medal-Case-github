...
public class Repository {
    ...
    public static final String MockData = "{\n" +
            ...
            "      {\n" +
            "        \"earned\": true,\n" +
            "        \"icon\": \"ic_longest_run.xml\",\n" +
            "        \"title\": \"Longest Run\",\n" +
            "        \"value\": \"100km\"\n" +
            "      },\n" +
            "      {\n" +
            "        \"earned\": true,\n" +
            "        \"icon\": \"ic_highest_elevation.xml\",\n" +
            "        \"title\": \"Highest Elevation\",\n" +
            "        \"value\": \"2095ft\"\n" +
            "      },\n" +
            "      {\n" +
            "        \"earned\": true,\n" +
            "        \"icon\": \"ic_fastest_5k.xml\",\n" +
            "        \"title\": \"Fastest 5k\",\n" +
            "        \"value\": \"00:32:00\"\n" +
            "      },\n" +
            "      {\n" +
            "        \"earned\": true,\n" +
            "        \"icon\": \"ic_fastest_10k.xml\",\n" +
            "        \"title\": \"10k\",\n" +
            "        \"value\": \"1:22:00\"\n" +
            "      },\n" +
            "      {\n" +
            "        \"earned\": true,\n" +
            "        \"icon\": \"ic_fastest_half_marathon.xml\",\n" +
            "        \"title\": \"Half Marathon\",\n" +
            "        \"value\": \"2:44:00\"\n" +
            "      },\n" +
            "      {\n" +
            "        \"earned\": false,\n" +
            "        \"icon\": \"ic_fastest_marathon.xml\",\n" +
            "        \"title\": \"Marathon\",\n" +
            "        \"value\": \"Not Yet\"\n" +
            "      }\n" +
            "    ]\n" +
            ...
            "      {\n" +
            "        \"earned\": true,\n" +
            "        \"icon\": \"virtual_half_marathon_race.xml\",\n" +
            "        \"title\": \"Virtual Half Marathon\",\n" +
            "        \"value\": \"100km\"\n" +
            "      },\n" +
            "      {\n" +
            "        \"earned\": true,\n" +
            "        \"icon\": \"tokyo_kakone_ekiden.xml\",\n" +
            "        \"title\": \"Tokyo-Hakone Ekiden\",\n" +
            "        \"value\": \"2095ft\"\n" +
            "      },\n" +
            "      {\n" +
            "        \"earned\": true,\n" +
            "        \"icon\": \"virtual_10k_race.xml\",\n" +
            "        \"title\": \"Virtual 10k Race\",\n" +
            "        \"value\": \"01:22:22\"\n" +
            "      },\n" +
            "      {\n" +
            "        \"earned\": true,\n" +
            "        \"icon\": \"hakone_ekiden.xml\",\n" +
            "        \"title\": \"Hakone Ekiden\",\n" +
            "        \"value\": \"1:11:20\"\n" +
            "      },\n" +
            "      {\n" +
            "        \"earned\": true,\n" +
            "        \"icon\": \"mizuno_singapore_ekiden.xml\",\n" +
            "        \"title\": \"Mizuno Singapore Ekiden\",\n" +
            "        \"value\": \"2:44:00\"\n" +
            "      },\n" +
            "      {\n" +
            "        \"earned\": true,\n" +
            "        \"icon\": \"virtual_5k_race.xml\",\n" +
            "        \"title\": \"Virtual 5k\",\n" +
            "        \"value\": \"00:28:21\"\n" +
            "      }\n" +
            "    ]\n" +
    ...
    public void toJson() {
        ...
        Medal m1 = new Medal();
        m1.icon = "ic_longest_run.xml";
        m1.title = "Longest Run";
        m1.value = "100km";
        m1.earned = true;

        Medal m2 = new Medal();
        m2.icon = "ic_highest_elevation.xml";
        m2.title = "Highest Elevation";
        m2.value = "2095ft";
        m2.earned = true;

        Medal m3 = new Medal();
        m3.icon = "ic_fastest_5k.xml";
        m3.title = "Fastest 5k";
        m3.value = "00:32:00";
        m3.earned = true;

        Medal m4 = new Medal();
        m4.icon = "ic_fastest_10k.xml";
        m4.title = "10k";
        m4.value = "1:22:00";
        m4.earned = true;

        Medal m5 = new Medal();
        m5.icon = "ic_fastest_half_marathon.xml";
        m5.title = "Half Marathon";
        m5.value = "2:44:00";
        m5.earned = true;

        Medal m6 = new Medal();
        m6.icon = "ic_fastest_marathon.xml";
        m6.title = "Marathon";
        m6.value = "Not Yet";
        m6.earned = false;
        ...
        m1 = new Medal();
        m1.icon = "virtual_half_marathon_race.xml";
        m1.title = "Virtual Half Marathon";
        m1.value = "100km";
        m1.earned = true;

        m2 = new Medal();
        m2.icon = "tokyo_kakone_ekiden.xml";
        m2.title = "Tokyo-Hakone Ekiden";
        m2.value = "2095ft";
        m2.earned = true;

        m3 = new Medal();
        m3.icon = "virtual_10k_race.xml";
        m3.title = "Virtual 10k Race";
        m3.value = "01:22:22";
        m3.earned = true;

        m4 = new Medal();
        m4.icon = "hakone_ekiden.xml";
        m4.title = "Hakone Ekiden";
        m4.value = "1:11:20";
        m4.earned = true;

        m5 = new Medal();
        m5.icon = "mizuno_singapore_ekiden.xml";
        m5.title = "Mizuno Singapore Ekiden";
        m5.value = "2:44:00";
        m5.earned = true;

        m6 = new Medal();
        m6.icon = "virtual_5k_race.xml";
        m6.title = "Virtual 5k";
        m6.value = "00:28:21";
        m6.earned = true;

        Medal m7 = new Medal();
        m7.icon = "virtual_10k_race.xml";
